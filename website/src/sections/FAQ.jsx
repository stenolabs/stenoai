...
const faqs = [
  { q: "What's included for free?", a: "Unlimited local transcription and summarization. No account, no tier, no upsell. StenographAI is open source. You can build and run it yourself if you prefer." },
  ...
  { q: "Is my data really private?", a: "Yes. StenographAI makes no network requests with your meeting content, and recordings, transcripts, and summaries never leave your device. The source is open, so you can verify it yourself, or have your security team do so. (Anonymous usage telemetry is on by default and can be switched off in Settings.)" },
  { q: "Does StenographAI help with HIPAA, GDPR, or SOC 2 compliance?", a: "StenographAI processes and stores your meeting recordings, transcripts, and summaries on your device and never sends them to any server, so there's no third-party processor handling your meeting data — which removes a meaningful part of HIPAA and GDPR exposure. It doesn't hand you compliance: those frameworks also cover safeguards, agreements, and processes that stay your responsibility. We don't claim to be a 'certified' service, because there's no cloud service handling your meetings to certify. SOC 2, for example, audits a cloud vendor's controls; because StenographAI keeps your meetings on-device, there's no such vendor in that path. (StenographAI does send anonymous, opt-out usage telemetry — never your meeting content.) The source is open, so your security team can verify exactly what is and isn't sent. See the industry pages under Enterprise for government and defence specifics." },
  { q: "How accurate is the transcription?", a: "StenographAI uses Parakeet TDT v3 for live transcription (25 European languages) and Whisper for languages outside that set, including Chinese, Japanese, Arabic, Korean, and Hindi (99 languages total). Results depend on audio clarity — quiet rooms and good microphones produce the best outcomes." },
  ...
  { q: "Does it work with remote meetings?", a: "Yes. StenographAI captures system audio and microphone simultaneously. Both sides of a Zoom, Teams, or Meet call are transcribed without any bot joining the meeting." },
  { q: "Does it need an internet connection to run?", a: "No. Once the models are downloaded during first-run setup, recording, transcription, and summarization all happen offline. StenographAI makes no network requests with your meeting content. The app itself still checks for updates and sends anonymous usage telemetry, which you can switch off in Settings." },
  ...
  { q: "Does it identify different speakers?", a: "Yes. StenographAI labels who's talking with live [You] / [Others] attribution during the recording, carried through to the final transcript." },
];
